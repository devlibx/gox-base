...
//
//	mockgen -destination=rate_limiter_mock.go -package=ratelimiterRedis -source=ratelimiter.go
//

// Package ratelimiterRedis is a generated GoMock package.
...
func (mr *MockactionAllowerMockRecorder) Allow(ctx, key, limit any) *gomock.Call {
