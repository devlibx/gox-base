...
//
//	mockgen -source=time_takne_helper.go -destination=../mocks/util/mock_time_takne_helper.go -package=mockUtil
//
...
func (mr *MockCaptureMockRecorder) Record(msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
