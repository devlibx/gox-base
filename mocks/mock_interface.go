...
//
//	mockgen -source=interface.go -destination=mocks/mock_interface.go -package=mockGox
//
...
func (mr *MockTimeServiceMockRecorder) Sleep(d any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Sleep indicates an expected call of Sleep.
func (mr *MockCrossFunctionMockRecorder) Sleep(d any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
