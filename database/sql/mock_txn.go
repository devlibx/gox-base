...
//
//	mockgen -source=txn.go -destination=./mock_txn.go -package=goxSql
//

// Package goxSql is a generated GoMock package.
package goxSql
...
type MockTxnBeginner struct {
	ctrl     *gomock.Controller
	recorder *MockTxnBeginnerMockRecorder
	isgomock struct{}
}

// MockTxnBeginnerMockRecorder is the mock recorder for MockTxnBeginner.
type MockTxnBeginnerMockRecorder struct {
	mock *MockTxnBeginner
}

// NewMockTxnBeginner creates a new mock instance.
func NewMockTxnBeginner(ctrl *gomock.Controller) *MockTxnBeginner {
	mock := &MockTxnBeginner{ctrl: ctrl}
	mock.recorder = &MockTxnBeginnerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockTxnBeginner) EXPECT() *MockTxnBeginnerMockRecorder {
	return m.recorder
}

// Begin mocks base method.
func (m *MockTxnBeginner) Begin() (Tx, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTxnBeginnerMockRecorder) Begin() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Begin", reflect.TypeOf((*MockTxnBeginner)(nil).Begin))
}
...
func (mr *MockTxMockRecorder) Stmt(stmt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
